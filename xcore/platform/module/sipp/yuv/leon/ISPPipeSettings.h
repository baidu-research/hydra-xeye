...
//#define ISPC_BAYER_BITS 10 //Move to specific sensor driver
...
//IMX214
#define SIPP_ISP_PIPE_BUFFER_WIDTH_IMX214  SIPP_ISP_PIPE_BUFFER_WIDTH        
#define SIPP_ISP_PIPE_BUFFER_HEIGHT_IMX214  SIPP_ISP_PIPE_BUFFER_HEIGHT   
...
#define ISPC_RAW_GAIN_GR_AR0330    0x010b    // 16 bits
#define ISPC_RAW_GAIN_R_AR0330     0x0123    // 16 bits
#define ISPC_RAW_GAIN_B_AR0330     0x011e    // 16 bits
#define ISPC_RAW_GAIN_GB_AR0330    0x010b   // 16 bits


#define ISPC_RAW_GAIN_R     0x0100    // 16 bits
#define ISPC_RAW_GAIN_GR    0x0070    // 16 bits
#define ISPC_RAW_GAIN_GB    0x0090    // 16 bits
...
///////////////////////////////////////////
// Color Combination filter,sensor specific, move to sensor driver
