...
#ifndef _AR0330_2L_1920x1080_RAW10_30Hz_H_
#define _AR0330_2L_1920x1080_RAW10_30Hz_H_

#include "mv_types.h"
#include "CameraDefines.h"
#include "ar0330_common.h"

#define AR0330_2L_1920x1080_RAW10_30Hz_I2C_CONFIG_STEPS (3)
...
#define COARSE_INTEGRATION_TIME       780    // default:16(0X0010) //390:10ms , 
...
const u16 ar0330_2L_1920x1080_Raw10_30Hz_I2Cregs[][2] = {
...
I2CConfigDescriptor ar0330_2L_1920x1080_Raw10_30Hz_mipiCfg_i2cConfigSteps[AR0330_2L_1920x1080_RAW10_30Hz_I2C_CONFIG_STEPS] =
{
    {   .numberOfRegs = (sizeof(ar0330_2L_1920x1080_Raw10_30Hz_I2Cregs)/sizeof(ar0330_2L_1920x1080_Raw10_30Hz_I2Cregs[0]) -2),
        .delayMs = 10,
    },
...
//Trying 20fps
const mipiSpec ar0330_2L_1920x1080_Raw10_30Hz_mipiCfg =
{
...
GenericCamSpec ar0330_2L_1920x1080_Raw10_30Hz_camCfg =
{
    .frameWidth            = 1920,
    .frameHeight           = 1080,
    .hBackPorch            = 0,
    ...
    .mipiCfg               = &ar0330_2L_1920x1080_Raw10_30Hz_mipiCfg,
    .idealRefFreq          = 24,
    .sensorI2CAddress1     = AR0330_I2C_ADDRESS,
    .sensorI2CAddress2     = 0,             //only used for stereo cameras
    .nbOfI2CConfigSteps    = AR0330_2L_1920x1080_RAW10_30Hz_I2C_CONFIG_STEPS,
    .i2cConfigSteps        = ar0330_2L_1920x1080_Raw10_30Hz_mipiCfg_i2cConfigSteps,
    .regSize               = 2,
    .regValues             = ar0330_2L_1920x1080_Raw10_30Hz_I2Cregs,
};

#endif // _AR0330_2L_1920x1080_RAW10_30Hz_H_
