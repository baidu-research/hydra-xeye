...
static XeyeSensorType_t Xeye_Sensor = Sensor_AR0330;
...
void configCam214SIPPDebayerHdmi(Cam214SIPPDebayerHdmi *pPl)
{
  ...
  // fields as defined in the filter property window
   ...
   sigmaDnsMa2x5x0Cfg->blcGR=42;
   sigmaDnsMa2x5x0Cfg->blcR=42;
   sigmaDnsMa2x5x0Cfg->blcB=42;
   sigmaDnsMa2x5x0Cfg->blcGB=42;
   ...
   rawMa2x5x0Cfg->cfg=      RAW_CFG(BAYER,BAYER_PATTERN_locate,GRGB_IMBAL_EN,0,AE_PATCH_STATS_EN,AE_RGB_HIST_STATS_EN,(ISPC_BAYER_BITS - 1),ISPC_GRGB_IMBAL_THRESHOLD,0,AF_PATCH_STATS_EN,BAYER_2x2_MODE,AE_Y_HIST_STATS_EN,HOT_COLD_PIX_SUPPRESS_EN);
    ...
    if (Xeye_Sensor == Sensor_IMX378) {
        rawMa2x5x0Cfg->gainSat[0]=((ISPC_RAW_CLAMP_0<<16) | ISPC_RAW_GAIN_GR_IMX378 );
        rawMa2x5x0Cfg->gainSat[1]= ((ISPC_RAW_CLAMP_1<<16) | ISPC_RAW_GAIN_R_IMX378 );
        rawMa2x5x0Cfg->gainSat[2]= ((ISPC_RAW_CLAMP_2<<16) | ISPC_RAW_GAIN_B_IMX378 );
        rawMa2x5x0Cfg->gainSat[3]= ((ISPC_RAW_CLAMP_3<<16) | ISPC_RAW_GAIN_GB_IMX378 );
    } else {
        rawMa2x5x0Cfg->gainSat[0]=((ISPC_RAW_CLAMP_0<<16) | ISPC_RAW_GAIN_GR_IMX214 );
        rawMa2x5x0Cfg->gainSat[1]= ((ISPC_RAW_CLAMP_1<<16) | ISPC_RAW_GAIN_R_IMX214 );
        rawMa2x5x0Cfg->gainSat[2]= ((ISPC_RAW_CLAMP_2<<16) | ISPC_RAW_GAIN_B_IMX214 );
        rawMa2x5x0Cfg->gainSat[3]= ((ISPC_RAW_CLAMP_3<<16) | ISPC_RAW_GAIN_GB_IMX214 );
    }
...
void isp_pipeline_params_update(Cam214SIPPDebayerHdmi *pPl, int ccm_index) {
   ...
   ccombCreateCoeffs(ccm_index);
   
    switch(ccm_index)
    {
      case ChinaMobileStore: 
         rawMa2x5x0Cfg->gainSat[0]=((ISPC_RAW_CLAMP_0<<16) | ISPC_RAW_GAIN_GR_AR0330_D50 );
         rawMa2x5x0Cfg->gainSat[1]= ((ISPC_RAW_CLAMP_1<<16) | ISPC_RAW_GAIN_R_AR0330_D50 );
         rawMa2x5x0Cfg->gainSat[2]= ((ISPC_RAW_CLAMP_2<<16) | ISPC_RAW_GAIN_B_AR0330_D50 );
         rawMa2x5x0Cfg->gainSat[3]= ((ISPC_RAW_CLAMP_3<<16) | ISPC_RAW_GAIN_GB_AR0330_D50 );
         break;
      case HuaweiHonorStore: 
         rawMa2x5x0Cfg->gainSat[0]=((ISPC_RAW_CLAMP_0<<16) | ISPC_RAW_GAIN_GR_AR0330_D65 );
         rawMa2x5x0Cfg->gainSat[1]= ((ISPC_RAW_CLAMP_1<<16) | ISPC_RAW_GAIN_R_AR0330_D65 );
         rawMa2x5x0Cfg->gainSat[2]= ((ISPC_RAW_CLAMP_2<<16) | ISPC_RAW_GAIN_B_AR0330_D65 );
         rawMa2x5x0Cfg->gainSat[3]= ((ISPC_RAW_CLAMP_3<<16) | ISPC_RAW_GAIN_GB_AR0330_D65 );
         break;
      default:
         rawMa2x5x0Cfg->gainSat[0]=((ISPC_RAW_CLAMP_0<<16) | ISPC_RAW_GAIN_GR_AR0330_D50 );
         rawMa2x5x0Cfg->gainSat[1]= ((ISPC_RAW_CLAMP_1<<16) | ISPC_RAW_GAIN_R_AR0330_D50 );
