...
//IMX214
#define SIPP_ISP_PIPE_BUFFER_WIDTH_IMX214         1152
#define SIPP_ISP_PIPE_BUFFER_HEIGHT_IMX214        768
...
#define SIPP_ISP_PIPE_BUFFER_WIDTH         1152 
#define SIPP_ISP_PIPE_BUFFER_HEIGHT        768
...
#define ISPC_SIGMA_NOISE_FLOOR  0
#define ISPC_SIGMA_THRESH1_P0   0
#define ISPC_SIGMA_THRESH2_P0   0
#define ISPC_SIGMA_THRESH1_P1   0
#define ISPC_SIGMA_THRESH2_P1   0
#define ISPC_SIGMA_THRESH1_P2   0
#define ISPC_SIGMA_THRESH2_P2   0
#define ISPC_SIGMA_THRESH1_P3   0
#define ISPC_SIGMA_THRESH2_P3   0
...
#define ISPC_GRGB_IMBAL_PLAT_DARK    68
#define ISPC_GRGB_IMBAL_DECAY_DARK   88
#define ISPC_GRGB_IMBAL_PLAT_BRIGHT  320
#define ISPC_GRGB_IMBAL_DECAY_BRIGHT 348
#define ISPC_GRGB_IMBAL_THRESHOLD    12    // 8 bits
...
#define ISPC_RAW_GAIN_R_IMX214     0x010b    // 16 bits
#define ISPC_RAW_GAIN_GR_IMX214    0x0121    // 16 bits
#define ISPC_RAW_GAIN_GB_IMX214    0x0121    // 16 bits
#define ISPC_RAW_GAIN_B_IMX214     0x0156    // 16 bits

#define ISPC_RAW_GAIN_R     0x0100    // 16 bits
#define ISPC_RAW_GAIN_GR    0x0100    // 16 bits
#define ISPC_RAW_GAIN_GB    0x0100    // 16 bits
#define ISPC_RAW_GAIN_B     0x0100    // 16 bits

#define ISPC_RAW_GAIN_R_AR0330     0x450    // 16 bits
#define ISPC_RAW_GAIN_GR_AR0330    0x450    // 16 bits
#define ISPC_RAW_GAIN_GB_AR0330    0x450    // 16 bits
#define ISPC_RAW_GAIN_B_AR0330     0x450    // 16 bits

#define ISPC_RAW_GAIN_R_AR0330_D50     0x010b    // 16 bits
#define ISPC_RAW_GAIN_GR_AR0330_D50    0x0121    // 16 bits
#define ISPC_RAW_GAIN_GB_AR0330_D50    0x0121    // 16 bits
#define ISPC_RAW_GAIN_B_AR0330_D50     0x0156    // 16 bits

#define ISPC_RAW_GAIN_R_AR0330_D65     0x0158    // 16 bits
#define ISPC_RAW_GAIN_GR_AR0330_D65    0x012a    // 16 bits
#define ISPC_RAW_GAIN_GB_AR0330_D65    0x012a    // 16 bits
#define ISPC_RAW_GAIN_B_AR0330_D65     0x010b    // 16 bits

#define ISPC_RAW_GAIN_R_AR0144     0x0100    // 16 bits
#define ISPC_RAW_GAIN_GR_AR0144    0x0100    // 16 bits
#define ISPC_RAW_GAIN_GB_AR0144    0x0100    // 16 bits
#define ISPC_RAW_GAIN_B_AR0144     0x0100    // 16 bits

#define ISPC_RAW_CLAMP_0_AR0144    4095    // 16 bits
#define ISPC_RAW_CLAMP_1_AR0144    4095    // 16 bits
#define ISPC_RAW_CLAMP_2_AR0144    4095    // 16 bits
#define ISPC_RAW_CLAMP_3_AR0144    4095    // 16 bits
...
#define ISPC_DEBAYER_BITS       10
#define RGB_EN                   1
#define FORCE_RB_ZERO            0
#define IMAGE_ORDER_OUT          P_RGB
#define OUTPUT_PLANE_NO          3

#define ISPC_DEMOSAIC_MIX_SLOPE            1700
#define ISPC_DEMOSAIC_MIX_OFFSET           190
#define ISPC_DEMOSAIC_MIX_GRADIENT_MUL     230
...
#define ISPC_LTM_FILTER_TH1    1

// DoG Denoise params:
#define ISPC_DOG_THR           0
#define ISPC_DOG_STRENGTH      0
...
#define ISPC_LUMA_DNS_F2         0xe5a45440
...
#define ISPC_LUMA_DNS_STRENGTH  22.000000
#define ISPC_LUMA_DNS_ALPHA     72 // 8bit value
...
#define ISPC_SHARP_SIGMA            1.150000
#define ISPC_SHARP_STRENGTH_DARKEN  1.400000
#define ISPC_SHARP_STRENGTH_LIGHTEN 1.400000
#define ISPC_SHARP_ALPHA            0.650000
#define ISPC_SHARP_OVERSHOOT        1.100000
#define ISPC_SHARP_UNDERSHOOT       0.870000
...
#define ISPC_CGEN_PFR_STRENGTH          10
#define ISPC_CGEN_DESAT_OFFSET          0
#define ISPC_CGEN_DESAT_SLOPE           11
...
#define ISPC_CHROMA_MEDIAN_MIX_SLOPE    230
#define ISPC_CHROMA_MEDIAN_MIX_OFFSET   5200


///////////////////////////////////////////
// Chroma Dns filter
#define ISPC_CHROMA_DNS_TH_R    6
#define ISPC_CHROMA_DNS_TH_G    7
#define ISPC_CHROMA_DNS_TH_B    8
#define ISPC_CHROMA_DNS_LIMIT   7
...
#define ISPC_GREY_DESAT_OFFSET 11
#define ISPC_GREY_DESAT_SLOPE  230
