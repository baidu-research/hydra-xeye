...
int parse_config_file(FileMap *config_file_map,
    ...
    if (NULL == config_file_map || NULL == xeye_config) {
    ...
    do {
        ...
        if (cJSON_IsNumber(enable_preprocess)) {
            xeye_config->enable_preprocess = enable_preprocess->valueint;
        } else {
        ...
        if (cJSON_IsNumber(enable_resize)) {
            xeye_config->enable_resize = enable_resize->valueint;
        } else {
        ...
        if (cJSON_IsNumber(height)) {
            xeye_config->resize_height = height->valueint;
        } else {
        ...
        if (cJSON_IsNumber(width)) {
            xeye_config->resize_width = width->valueint;
        } else {
        ...
        if (cJSON_IsNumber(enable_mean)) {
            xeye_config->enable_mean = enable_mean->valueint;
        } else {
        ...
        if (cJSON_IsNumber(b)) {
            xeye_config->mean_b = (float)b->valuedouble;
        } else {
        ...
        if (cJSON_IsNumber(g)) {
            xeye_config->mean_g = (float)g->valuedouble;
        } else {
        ...
        if (cJSON_IsNumber(r)) {
            xeye_config->mean_r = (float)r->valuedouble;
        } else {
        ...
        if (cJSON_IsNumber(enable_scale)) {
            xeye_config->enable_scale = enable_scale->valueint;
        } else {
        ...
        if (cJSON_IsNumber(scale)) {
            xeye_config->scale = (float)scale->valuedouble;
        } else {
        ...
        if (cJSON_IsNumber(with_original_image)) {
            xeye_config->with_original_image = with_original_image->valueint;
        } else {
